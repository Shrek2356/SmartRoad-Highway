...
export const HELP_PAGES = [
  ...
  { path:'/system-settings', title:'系统设置', group:'系统配置', roles:['admin'], description:'管理桌面环境、连接、视觉偏好、账号与业务备份。', keywords:'Python 端口 启动 主题 明暗 备份 用户 桌面',
    steps:['选择专业工作台或作品展示视图，保留自己习惯的明暗主题。','在桌面与连接中修改 Python 或服务地址，并检查实际连接。','用户与业务备份中管理账号；完整迁移需另保存图片、知识库及配置。'], result:'可持久保存的环境与个性化设置。', caution:'桌面启动配置需重启才生效；业务库备份不是整个系统的完整备份。', next:'/help-center' },
